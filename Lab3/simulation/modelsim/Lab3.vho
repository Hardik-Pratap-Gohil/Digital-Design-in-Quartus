...
-- input_vector[1]	=>  Location: PIN_45,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|OR1|OR6|Y~0_combout\ : std_logic;
SIGNAL \add_instance|OR1|OR6|Y~1_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|OR1|OR6|Y~1_combout\,
	devoe => ww_devoe,
...
\add_instance|OR1|OR6|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|OR1|OR6|Y~0_combout\ = (\input_vector[4]~input_o\ & ((\input_vector[3]~input_o\ & ((\input_vector[2]~input_o\))) # (!\input_vector[3]~input_o\ & (!\input_vector[1]~input_o\ & !\input_vector[2]~input_o\)))) # (!\input_vector[4]~input_o\ & 
-- ((\input_vector[1]~input_o\ $ (\input_vector[2]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1000110101010010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	...
	combout => \add_instance|OR1|OR6|Y~0_combout\);

-- Location: LCCOMB_X13_Y2_N18
\add_instance|OR1|OR6|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|OR1|OR6|Y~1_combout\ = (\input_vector[0]~input_o\ & ((\add_instance|OR1|OR6|Y~0_combout\) # ((\input_vector[1]~input_o\ & !\input_vector[3]~input_o\)))) # (!\input_vector[0]~input_o\ & (\input_vector[1]~input_o\ & (!\input_vector[3]~input_o\ 
-- & \add_instance|OR1|OR6|Y~0_combout\)))
...
PORT MAP (
	...
	datad => \add_instance|OR1|OR6|Y~0_combout\,
	combout => \add_instance|OR1|OR6|Y~1_combout\);
